...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'typescript', 'java', 'angular' },
    ...
    config = function(_, opts)
      ...
      -- vim.treesitter.language.register("angular", "angular.html") -- Register the filetype with treesitter for the `angular` language/parser-- There are additional nvim-treesitter modules that you can use to interact
